    ...
    <div className="mx-auto max-w-4xl p-4 pb-20 md:p-6">
      ...
      {problem.hints && problem.hints.length > 0 && (
        <details className="mb-6 group">
          <summary className="cursor-pointer rounded-lg border border-border bg-bg-elevated px-4 py-2 text-sm font-medium text-text-secondary transition-colors hover:bg-bg-hover">
      ...
      <div className="space-y-3">
        ...
        <CodeEditor value={code} onChange={setCode} language="javascript" placeholder="// Viết code giải tại đây" />
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={handleRun}
            disabled={running}
            className="rounded-lg bg-accent px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-accent-strong disabled:opacity-50"
          >
